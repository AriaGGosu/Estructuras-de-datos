...
// 9 multiplicamos el resultModulo x 11 y lo restamos al total de la suma 
// esto quedaria de esta manera resultModulo = (resultado - (resultModulo x 11))

// 10 finalmente a 11 le restamos el resultModulo y esto lo guardamos en una variable

// 11 el resultado de esto sera el digito verificador 
...
const verificadorRut = numero => {
    ...
    // 8
    let modulo = total % 11;
    console.log("el resultado de el total modulo 11 es " + 156 % 11);

    // console.log(total);
    console.log(modulo);
    let moduloTotal = modulo * 11;

    console.log(moduloTotal);
    moduloTotal = total - moduloTotal;
    console.log(moduloTotal);

}

verificadorRut(175863249);
